                            ...
                            <div class="swiper-slide">
                                <div class="eael-lc-logo-wrap">
									...
									if ( ! empty( $item['logo_title'] ) ) {
										...
										$title_html = '<' . $title_tag . ' class="eael-logo-carousel-title">';
										if ( ! empty( $item['link']['url'] ) ) {
											$title_html .= '<a ' . $this->get_render_attribute_string( 'logo-link' . $i ) . '>';
										}
										$title_html .= $item['logo_title'];
										if ( ! empty( $item['link']['url'] ) ) {
											$title_html .= '</a>';
										}
										$title_html .= '</' . $title_tag . '>';
										echo wp_kses( $title_html, Helper::eael_allowed_icon_tags() );
									}
									?>
                                </div>
                            </div>
