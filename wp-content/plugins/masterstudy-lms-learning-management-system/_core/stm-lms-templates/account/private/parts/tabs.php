...
if ( is_user_logged_in() ) {
	...
	?>
	<h2 class="cap-login-name"><?php echo esc_html( stm_lms_minimize_word( sprintf( esc_html__( 'Xin chào, %s', 'masterstudy-lms-learning-management-system' ), $user['login'] ), 45 ) ); ?></h2>
