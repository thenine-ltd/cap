...
class ClientResolver
{
    ...
    {
        return \WPMailSMTP\Vendor\Aws\Configuration\ConfigurationResolver::resolve('disable_request_compression', \false, 'bool', $args);
    }
    ...
    {
        return \WPMailSMTP\Vendor\Aws\Configuration\ConfigurationResolver::resolve('ignore_configured_endpoint_urls', \false, 'bool', $args);
    }
    ...
    {
        return \WPMailSMTP\Vendor\Aws\Configuration\ConfigurationResolver::resolve('sigv4a_signing_region_set', '', 'string');
    }
    ...
    {
        return \WPMailSMTP\Vendor\Aws\Configuration\ConfigurationResolver::resolve('region', '', 'string');
    }
