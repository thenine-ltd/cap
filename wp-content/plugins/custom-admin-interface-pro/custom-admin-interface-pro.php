...
*/
    ...
    */
    ...
    $custom_admin_interface_pro_post_types = array(
        ...
        array(
            'single' => __( 'Admin Menu Page' , 'custom-admin-interface-pro' ),
            'plural' => __( 'Admin Menu Pages' , 'custom-admin-interface-pro' ),
        ),
        array(
    ...
    */
    function custom_admin_interface_pro_register_custom_post_types() {
        ...
        foreach($custom_admin_interface_pro_post_types as $post_type){
            ...
            $post_types_with_additional_supports = array('admin_toolbar','admin_menu','admin_menu_page','admin_notice','custom_admin_code','dashboard_widget','custom_frontend_code');
